...
#### [v2.17.1](https://github.com/Infinity-Degrees/idx-player/compare/v2.17.0...v2.17.1)

- error [`01ba5d7`](https://github.com/Infinity-Degrees/idx-player/commit/01ba5d7d44aafc5d53bb772e37d3586c017ae3d0)

#### v2.17.0

> 11 April 2024

- feat: add Mux + hls.js support back in [`#1769`](https://github.com/Infinity-Degrees/idx-player/pull/1769)
- fix: dynamic Mux import [`#1758`](https://github.com/Infinity-Degrees/idx-player/pull/1758)
- docs: fix demo URL [`#1752`](https://github.com/Infinity-Degrees/idx-player/pull/1752)
- docs: readme updates, next-video callout [`#1751`](https://github.com/Infinity-Degrees/idx-player/pull/1751)
- chore(cd): remove --changelog b/c auto-changelog [`#1750`](https://github.com/Infinity-Degrees/idx-player/pull/1750)
- feat: add Mux player [`#1748`](https://github.com/Infinity-Degrees/idx-player/pull/1748)
- chore(github-pages): add demo preview [`#1747`](https://github.com/Infinity-Degrees/idx-player/pull/1747)
- chore: remove unneeded config files [`#1744`](https://github.com/Infinity-Degrees/idx-player/pull/1744)
- Add aria-label to Preview component [`#1705`](https://github.com/Infinity-Degrees/idx-player/pull/1705)
- Add Deno-specific browser check [`#1632`](https://github.com/Infinity-Degrees/idx-player/pull/1632)
- docs: fix badges [`#1735`](https://github.com/Infinity-Degrees/idx-player/pull/1735)
- fix: cjs interop require default pita [`#1722`](https://github.com/Infinity-Degrees/idx-player/pull/1722)
- fix: repo url [`#1709`](https://github.com/Infinity-Degrees/idx-player/pull/1709)
- fix: pkg repository.url [`#1708`](https://github.com/Infinity-Degrees/idx-player/pull/1708)
- chore: add CD workflow [`#1706`](https://github.com/Infinity-Degrees/idx-player/pull/1706)
- chore: use Node matrix with 16.x, 18.x, 20.x [`#1688`](https://github.com/Infinity-Degrees/idx-player/pull/1688)
- docs: update demo App.js link [`#1689`](https://github.com/Infinity-Degrees/idx-player/pull/1689)
- fix: modernize build using esbuild [`#1684`](https://github.com/Infinity-Degrees/idx-player/pull/1684)
- Fix #1604 - FilePlayer does not work if I passed an array of urls [`#1612`](https://github.com/Infinity-Degrees/idx-player/pull/1612)
- fix: `src` sttribute become "undefinded" if `url` is an array [`#1648`](https://github.com/Infinity-Degrees/idx-player/pull/1648)
- Adding keepPlaying to other player types [`#1639`](https://github.com/Infinity-Degrees/idx-player/pull/1639)
- CI [`#1654`](https://github.com/Infinity-Degrees/idx-player/pull/1654)
- Swap out broken youtube URL [`#1659`](https://github.com/Infinity-Degrees/idx-player/pull/1659)
- Add keepPlaying to seekTo [`#1620`](https://github.com/Infinity-Degrees/idx-player/pull/1620)
- Added forceDisableHls option for FilePlayer [`#1625`](https://github.com/Infinity-Degrees/idx-player/pull/1625)
- added onPlaybackQualityChange prop [`#1636`](https://github.com/Infinity-Degrees/idx-player/pull/1636)
- Update the list of supported YouTube domains [`#1599`](https://github.com/Infinity-Degrees/idx-player/pull/1599)
- Added Vimeo Muteability [`#1588`](https://github.com/Infinity-Degrees/idx-player/pull/1588)
- Add forceSafariHLS option for FilePlayer [`#1560`](https://github.com/Infinity-Degrees/idx-player/pull/1560)
- fix: standalone has side effects [`#1586`](https://github.com/Infinity-Degrees/idx-player/pull/1586)
- Update light prop usage re: new feature in PR#1405 [`#1510`](https://github.com/Infinity-Degrees/idx-player/pull/1510)
- Extending valid DailyMotion URL regex  Fix #1430 [`#1516`](https://github.com/Infinity-Degrees/idx-player/pull/1516)
- Add `"sideEffects": false` to `package.json` [`#1524`](https://github.com/Infinity-Degrees/idx-player/pull/1524)
- responsive CSS fix [`#1533`](https://github.com/Infinity-Degrees/idx-player/pull/1533)
- add unbundled es6 build with jsx file extensions [`#1537`](https://github.com/Infinity-Degrees/idx-player/pull/1537)
- Replace Vimeo default preview thumbnail [`#1553`](https://github.com/Infinity-Degrees/idx-player/pull/1553)
- fix typo [`#1558`](https://github.com/Infinity-Degrees/idx-player/pull/1558)
- fix: empty src attr in StrictMode [`#1538`](https://github.com/Infinity-Degrees/idx-player/pull/1538)
- Add event playbackratechange on vimeo player [`#1502`](https://github.com/Infinity-Degrees/idx-player/pull/1502)
- feat: allow auto play on mixcloud player [`#1467`](https://github.com/Infinity-Degrees/idx-player/pull/1467)
- Fix onProgress not firing in Strict Mode [`#1465`](https://github.com/Infinity-Degrees/idx-player/pull/1465)
- Generate a file `dist/ReactPlayer.standalone-module.js` ES6 module [`#1425`](https://github.com/Infinity-Degrees/idx-player/pull/1425)
- ability to pass a component in light prop [`#1405`](https://github.com/Infinity-Degrees/idx-player/pull/1405)
- (fix): clear video src to prevent old video from continue to load [`#1360`](https://github.com/Infinity-Degrees/idx-player/pull/1360)
- apply interface onProgressProps at base.d.ts [`#1342`](https://github.com/Infinity-Degrees/idx-player/pull/1342)
- don't stack event listeners [`#1186`](https://github.com/Infinity-Degrees/idx-player/pull/1186)
- Add flvjs error handling, pass it to props onError method. [`#1426`](https://github.com/Infinity-Degrees/idx-player/pull/1426)
- Allow parameters after entry_id on kaltura [`#1432`](https://github.com/Infinity-Degrees/idx-player/pull/1432)
- adds support for youtube short urls [`#1438`](https://github.com/Infinity-Degrees/idx-player/pull/1438)
- Added .m4b extension to AUDIO_EXTENSIONS [`#1415`](https://github.com/Infinity-Degrees/idx-player/pull/1415)
- Adjust listener for kaltura [`#1226`](https://github.com/Infinity-Degrees/idx-player/pull/1226)
- update default HLS version to latest release [`#1402`](https://github.com/Infinity-Degrees/idx-player/pull/1402)
- Make pre-publish.js ES5 compatible [`#1393`](https://github.com/Infinity-Degrees/idx-player/pull/1393)
- fix: Add exception handling when seekTo is called with amount value 0 [`#1372`](https://github.com/Infinity-Degrees/idx-player/pull/1372)
- Add onSeek support to Twitch player [`#1354`](https://github.com/Infinity-Degrees/idx-player/pull/1354)
- Add attributes in FacebookConfig type [`#1351`](https://github.com/Infinity-Degrees/idx-player/pull/1351)
- handle setPlaybackRate error [`#1223`](https://github.com/Infinity-Degrees/idx-player/pull/1223)
- Add onPlaybackRateChange callback prop [`#1224`](https://github.com/Infinity-Degrees/idx-player/pull/1224)
- Ability to pass null to previewTabIndex [`#1256`](https://github.com/Infinity-Degrees/idx-player/pull/1256)
- Add media attribute to source tag in file player [`#1269`](https://github.com/Infinity-Degrees/idx-player/pull/1269)
- fix: don't defer MediaStream [`#1230`](https://github.com/Infinity-Degrees/idx-player/pull/1230)
- add title attribute to vimeo iframe [`#1229`](https://github.com/Infinity-Degrees/idx-player/pull/1229)
- Add oEmbedUrl as changeable prop [`#1333`](https://github.com/Infinity-Degrees/idx-player/pull/1333)
- update video extenstions to accept media fragments for time [`#1213`](https://github.com/Infinity-Degrees/idx-player/pull/1213)
- Add type for wrapper in base.d.ts [`#1234`](https://github.com/Infinity-Degrees/idx-player/pull/1234)
- Make facebook config type properties optional [`#1314`](https://github.com/Infinity-Degrees/idx-player/pull/1314)
- Adds previewTabIndex property to light mode [`#1169`](https://github.com/Infinity-Degrees/idx-player/pull/1169)
- Update YouTube URL pattern (#1170) [`#1171`](https://github.com/Infinity-Degrees/idx-player/pull/1171)
- Support Kaltura's HTML5 player [`#1082`](https://github.com/Infinity-Degrees/idx-player/pull/1082)
- fix: ensure lazy typedefs mirror defaults [`#1153`](https://github.com/Infinity-Degrees/idx-player/pull/1153)
- fix: nullify srcObject instead of calling removeAttribute [`#1145`](https://github.com/Infinity-Degrees/idx-player/pull/1145)
- updated basic types with fallback [`#1144`](https://github.com/Infinity-Degrees/idx-player/pull/1144)
- fix: remove srcObject attribute if next uri is not a MediaStream [`#1121`](https://github.com/Infinity-Degrees/idx-player/pull/1121)
- added soundcloud playlist preview button for demo page so developers can know it also supports sc playlists [`#1113`](https://github.com/Infinity-Degrees/idx-player/pull/1113)
- Add missing FLV props to TS defs [`#1122`](https://github.com/Infinity-Degrees/idx-player/pull/1122)
- FEAT: customize fallback through props for lazy loading [`#1133`](https://github.com/Infinity-Degrees/idx-player/pull/1133)
- fix: add playIcon prop to TS declaration [`#1084`](https://github.com/Infinity-Degrees/idx-player/pull/1084)
- Parse start time from twitch url [`#1046`](https://github.com/Infinity-Degrees/idx-player/pull/1046)
- Add explicit comment to set muted to true for autoplay [`#1036`](https://github.com/Infinity-Degrees/idx-player/pull/1036)
- Updates the default version of dash.js, hls.js [`#1056`](https://github.com/Infinity-Degrees/idx-player/pull/1056)
- Fix canPlayFile to support blob uri, fix #1023 [`#1041`](https://github.com/Infinity-Degrees/idx-player/pull/1041)
- Update CONTRIBUTING.md [`#1017`](https://github.com/Infinity-Degrees/idx-player/pull/1017)
- Add twitch config interface [`#996`](https://github.com/Infinity-Degrees/idx-player/pull/996)
- Fixes youtube player playsinline variable type [`#989`](https://github.com/Infinity-Degrees/idx-player/pull/989)
- Add descriptive text to Controls section [`#982`](https://github.com/Infinity-Degrees/idx-player/pull/982)
- added missing type for 'getSecondsLoaded' [`#977`](https://github.com/Infinity-Degrees/idx-player/pull/977)
- Make force disabling PIP dependent on prop [`#964`](https://github.com/Infinity-Degrees/idx-player/pull/964)
- vimeo: listen for bufferring events and handle with matching callbacks [`#975`](https://github.com/Infinity-Degrees/idx-player/pull/975)
- Hide wistia controls with controls prop [`#937`](https://github.com/Infinity-Degrees/idx-player/pull/937)
- dash deprecated method fix for different versions. [`#933`](https://github.com/Infinity-Degrees/idx-player/pull/933)
- wistia config types updated [`#931`](https://github.com/Infinity-Degrees/idx-player/pull/931)
- Add Wistia player id to support multiple players [`#905`](https://github.com/Infinity-Degrees/idx-player/pull/905)
- Match YouTube User Uploads [`#877`](https://github.com/Infinity-Degrees/idx-player/pull/877)
- Destroy previous vidyard player before creating new one [`#894`](https://github.com/Infinity-Degrees/idx-player/pull/894)
- Adds the missing default data for the selected player [`#864`](https://github.com/Infinity-Degrees/idx-player/pull/864)
- fix for soundcloud direct file link [`#803`](https://github.com/Infinity-Degrees/idx-player/pull/803)
- Update documented default hls.js version to 0.13.1 [`#806`](https://github.com/Infinity-Degrees/idx-player/pull/806)
- Move @ava/babel to devDependencies [`#794`](https://github.com/Infinity-Degrees/idx-player/pull/794)
- Bump handlebars from 4.2.0 to 4.5.3 [`#771`](https://github.com/Infinity-Degrees/idx-player/pull/771)
- Add showPreview() method to ReactPlayer typings [`#785`](https://github.com/Infinity-Degrees/idx-player/pull/785)
- Support to set custom facebook version [`#745`](https://github.com/Infinity-Degrees/idx-player/pull/745)
- fixes #733 [`#736`](https://github.com/Infinity-Degrees/idx-player/pull/736)
- Add PIP support for Safari [`#716`](https://github.com/Infinity-Degrees/idx-player/pull/716)
- Properly delete SDK requests [`#718`](https://github.com/Infinity-Degrees/idx-player/pull/718)
- Delete SDK requests array after loading error [`#711`](https://github.com/Infinity-Degrees/idx-player/pull/711)
- Add typedef support for MediaStream url source [`#674`](https://github.com/Infinity-Degrees/idx-player/pull/674)
- Do not use vimeo API to play vimeo hosted video files. [`#597`](https://github.com/Infinity-Degrees/idx-player/pull/597)
- Catches error on Vimeo play() [`#645`](https://github.com/Infinity-Degrees/idx-player/pull/645)
- Update Meteor section in readme [`#647`](https://github.com/Infinity-Degrees/idx-player/pull/647)
- [d.ts] Fix typing of arguments of onError handler [`#655`](https://github.com/Infinity-Degrees/idx-player/pull/655)
- Fix twitch permanent loading state when stream is offline [`#657`](https://github.com/Infinity-Degrees/idx-player/pull/657)
- Fix an issue with setting state in the Preview component after being unmounted. [`#658`](https://github.com/Infinity-Degrees/idx-player/pull/658)
- Soundcloud - fix autoplay delegation [`#614`](https://github.com/Infinity-Degrees/idx-player/pull/614)
- Implemented onBufferEnd cb prop for FilePlayer, YouTube and Facebook [`#615`](https://github.com/Infinity-Degrees/idx-player/pull/615)
- Add on error callback to wistia player [`#617`](https://github.com/Infinity-Degrees/idx-player/pull/617)
- align typings for seekTo method with code [`#619`](https://github.com/Infinity-Degrees/idx-player/pull/619)
- Really really small typo in README.md [`#606`](https://github.com/Infinity-Degrees/idx-player/pull/606)
- Allows wrapper proptype to be a ForwardRef component [`#556`](https://github.com/Infinity-Degrees/idx-player/pull/556)
- playsinline for Android wechat [`#544`](https://github.com/Infinity-Degrees/idx-player/pull/544)
- Fix broken URL for standalone script [`#546`](https://github.com/Infinity-Degrees/idx-player/pull/546)
- Accept youtube.com/playlist?list= URLs [`#541`](https://github.com/Infinity-Degrees/idx-player/pull/541)
- Support Chrome Picture In Picture (PIP) mode [`#504`](https://github.com/Infinity-Degrees/idx-player/pull/504)
- Typings - label in TrackProps [`#489`](https://github.com/Infinity-Degrees/idx-player/pull/489)
- fix: fix onProgress callback not firing during iOS live streams [`#497`](https://github.com/Infinity-Degrees/idx-player/pull/497)
- Update vimeo preload URL [`#509`](https://github.com/Infinity-Degrees/idx-player/pull/509)
- add absent methods signature [`#507`](https://github.com/Infinity-Degrees/idx-player/pull/507)
- Fix: signal multiple sources change to the browser [`#482`](https://github.com/Infinity-Degrees/idx-player/pull/482)
- Check null before accessing FilePlayer properties [`#465`](https://github.com/Infinity-Degrees/idx-player/pull/465)
-  Adds hlsOptions to FileConfig def [`#483`](https://github.com/Infinity-Degrees/idx-player/pull/483)
- Updated hls.js documentation link in README.md [`#440`](https://github.com/Infinity-Degrees/idx-player/pull/440)
- YouTube videos not forwarding `end` param [`#420`](https://github.com/Infinity-Degrees/idx-player/pull/420)
- Bump HLS.js [`#403`](https://github.com/Infinity-Degrees/idx-player/pull/403)
- Fix FilePlayer getSecondsLoaded [`#380`](https://github.com/Infinity-Degrees/idx-player/pull/380)
- Add support for custom players [`#364`](https://github.com/Infinity-Degrees/idx-player/pull/364)
- Include Mixcloud in README [`#342`](https://github.com/Infinity-Degrees/idx-player/pull/342)
- Fixes the onPause event propogation [`#336`](https://github.com/Infinity-Degrees/idx-player/pull/336)
- Support custom wrappers [`#334`](https://github.com/Infinity-Degrees/idx-player/pull/334)
- Match YouTube URL with extra parameters [`#332`](https://github.com/Infinity-Degrees/idx-player/pull/332)
- Do not load hls.js on iOS [`#293`](https://github.com/Infinity-Degrees/idx-player/pull/293)
- Vimeo On Demand URL Support [`#289`](https://github.com/Infinity-Degrees/idx-player/pull/289)
- Loop when player is running [`#257`](https://github.com/Infinity-Degrees/idx-player/pull/257)
- properly destroy HLS.JS and / or DASH.JS instances [`#254`](https://github.com/Infinity-Degrees/idx-player/pull/254)
- tweak Vimeo duration logic [`#251`](https://github.com/Infinity-Degrees/idx-player/pull/251)
- Update typings for onProgress callback [`#246`](https://github.com/Infinity-Degrees/idx-player/pull/246)
- Fix parameter name for Vimeo player configuration [`#243`](https://github.com/Infinity-Degrees/idx-player/pull/243)
- Updated TypeScript typings [`#235`](https://github.com/Infinity-Degrees/idx-player/pull/235)
- update of DOM listeners in FilePlayer when audio/video tags was switched [`#234`](https://github.com/Infinity-Degrees/idx-player/pull/234)
- Soundcloud: use Widget API instead of HTTP API [`#199`](https://github.com/Infinity-Degrees/idx-player/pull/199)
- Fixed broken TypeScript type definitions [`#230`](https://github.com/Infinity-Degrees/idx-player/pull/230)
- More accurate played fraction for Wistia [`#201`](https://github.com/Infinity-Degrees/idx-player/pull/201)
- Fix initial loading bug for Private Vimeo videos [`#187`](https://github.com/Infinity-Degrees/idx-player/pull/187)
- Apply all non-valid props to the wrapper element [`#183`](https://github.com/Infinity-Degrees/idx-player/pull/183)
- Add assertion for canPlay with https://vimeo [`#141`](https://github.com/Infinity-Degrees/idx-player/pull/141)
- Use npm 4.x on travis [`#143`](https://github.com/Infinity-Degrees/idx-player/pull/143)
- Use ubuntu 14.04 for travis [`#144`](https://github.com/Infinity-Degrees/idx-player/pull/144)
- fixed width & height of video when it is in fullscreen mode [`#151`](https://github.com/Infinity-Degrees/idx-player/pull/151)
- update webpack to 2.2.1 [`#156`](https://github.com/Infinity-Degrees/idx-player/pull/156)
- Wistia support [`#133`](https://github.com/Infinity-Degrees/idx-player/pull/133)
- PlaybackRate change feature [`#123`](https://github.com/Infinity-Degrees/idx-player/pull/123)
- Fix onProgress non-reporting if playing prop is not set. [`#127`](https://github.com/Infinity-Degrees/idx-player/pull/127)
- Add additional audio file extensions to regex [`#131`](https://github.com/Infinity-Degrees/idx-player/pull/131)
- Use node 6 on travis [`#130`](https://github.com/Infinity-Degrees/idx-player/pull/130)
- Pass DOM node to YouTube Player instead of ID [`#111`](https://github.com/Infinity-Degrees/idx-player/pull/111)
- update all dependencies [`#107`](https://github.com/Infinity-Degrees/idx-player/pull/107)
- Add `hidden` prop to ReactPlayer [`#102`](https://github.com/Infinity-Degrees/idx-player/pull/102)
- Add support for non-es5 compatible browsers [`#87`](https://github.com/Infinity-Degrees/idx-player/pull/87)
- Update supported file type regex [`#68`](https://github.com/Infinity-Degrees/idx-player/pull/68)
- Update README.md links [`#66`](https://github.com/Infinity-Degrees/idx-player/pull/66)
- Pass on error event [`#48`](https://github.com/Infinity-Degrees/idx-player/pull/48)
- Add FilePlayer support for urls with query string [`#45`](https://github.com/Infinity-Degrees/idx-player/pull/45)
- Use react-transform development setup [`#25`](https://github.com/Infinity-Degrees/idx-player/pull/25)
- Fix YouTube onReady bugs [`#21`](https://github.com/Infinity-Degrees/idx-player/pull/21)
- Prime players to enable autoplay when out of focus [`#13`](https://github.com/Infinity-Degrees/idx-player/pull/13)
- Configuration [`#4`](https://github.com/Infinity-Degrees/idx-player/pull/4)
- fix: dynamic Mux import (#1758) [`#1755`](https://github.com/Infinity-Degrees/idx-player/issues/1755)
- Fix #1604 - FilePlayer does not work if I passed an array of urls (#1612) [`#1604`](https://github.com/Infinity-Degrees/idx-player/issues/1604)
...
- Extending valid DailyMotion URL regex  Fix #1430 (#1516) [`#1430`](https://github.com/Infinity-Degrees/idx-player/issues/1430)
...
- Adjust listener for kaltura (#1226) [`#1202`](https://github.com/Infinity-Degrees/idx-player/issues/1202)
...
- fix: ensure lazy typedefs mirror defaults (#1153) [`#1146`](https://github.com/Infinity-Degrees/idx-player/issues/1146)
...
- Fix canPlayFile to support blob uri, fix #1023 (#1041) [`#1023`](https://github.com/Infinity-Degrees/idx-player/issues/1023)
...
- fixes #733 (#736) [`#733`](https://github.com/Infinity-Degrees/idx-player/issues/733)
...
- Update twitch URL pattern [`#267`](https://github.com/Infinity-Degrees/idx-player/issues/267)
...
- Update polyfill info [`#239`](https://github.com/Infinity-Degrees/idx-player/issues/239)
- Use React 16 for demo [`#241`](https://github.com/Infinity-Degrees/idx-player/issues/241)
- Tweak vimeo player logic [`#240`](https://github.com/Infinity-Degrees/idx-player/issues/240)
...
- Use single config prop [`#71`](https://github.com/Infinity-Degrees/idx-player/issues/71)
...
- Pass on event including error message and code onError [`#44`](https://github.com/Infinity-Degrees/idx-player/issues/44)
...
- **Breaking change:** Use lazy players [`1752b8d`](https://github.com/Infinity-Degrees/idx-player/commit/1752b8dc5b034910530325c1a3068c044c196f84)
- **Breaking change:** Remove preload support [`1baa227`](https://github.com/Infinity-Degrees/idx-player/commit/1baa227843e4424998ef22735e8b969cfa817b5e)
- **Breaking change:** Remove legacy config props [`9339efa`](https://github.com/Infinity-Degrees/idx-player/commit/9339efa3c23434189763af4a4e6c052eda74a467)
